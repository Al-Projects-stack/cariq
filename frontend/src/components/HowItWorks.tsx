...
const STEPS: Step[] = [
  {
    ...
    tech: "React Â· Pydantic validation",
    highlight: false,
  },
  {
    icon: <IconVector />,
  ...
  },
  {
    ...
    tech: "Pinecone Â· cosine similarity",
    highlight: true,
  },
  {
    icon: <IconDatabase />,
    ...
    tech: "RAG pipeline Â· FastAPI",
    highlight: false,
  },
  {
    icon: <IconSparkle />,
    label: "Answer Generation",
    description: "The LLM answers using only the retrieved context ,  grounded, never hallucinated.",
    tech: "LLM Â· FastAPI",
    highlight: false,
  },
  {
...
const ARCH_FLOW = [
  ...
  { label: "LLM Answer",     colour: "border-orange-800 bg-orange-950/40 text-orange-400" },
